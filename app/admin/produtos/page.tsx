              ...
              {filtered.map(product => {
                ...
                return (
                  <tr key={product.id} className="border-b border-nude-50 hover:bg-nude-50 transition-colors">
                    ...
                    <td className="p-4">
                      <span className="font-body text-sm font-medium text-[var(--color-gold)]">
                    ...
                    <td className="p-4 text-center">
                      <button
                        ...
                        title={product.visible ? 'Clique para ocultar' : 'Clique para exibir'}
                      >
                    ...
                    <td className="p-4">
                      <div className="flex items-center justify-end gap-2">
                        <Link
                          ...
                          className="p-2 text-nude-400 hover:text-nude-700 transition-colors"
                          title="Editar"
                        >
                          <Edit2 size={15} />
                        </Link>
